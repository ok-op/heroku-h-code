...
class _BotCommands:
    def __init__(self):
        ...
        self.LeechCommand = getCommand('LEECH_CMD', f'1leech{CMD_INDEX}')
        self.UnzipLeechCommand = getCommand('UNZIPLEECH_CMD', f'1unzipleech{CMD_INDEX}')
        self.ZipLeechCommand = getCommand('ZIPLEECH_CMD', f'1zipleech{CMD_INDEX}')
        self.QbLeechCommand = getCommand('QBLEECH_CMD', f'1qbleech{CMD_INDEX}')
        self.QbUnzipLeechCommand = getCommand('1QBZIPLEECH_CMD', f'qbunzipleech{CMD_INDEX}')
        self.QbZipLeechCommand = getCommand('1QBUNZIPLEECH_CMD', f'qbzipleech{CMD_INDEX}')
        self.YtdlLeechCommand =getCommand('1YTDLLEECH_CMD',  f'ytdlleech{CMD_INDEX}')
        self.YtdlZipLeechCommand = getCommand('1YTDLZIPLEECH_CMD', f'ytdlzipleech{CMD_INDEX}')
        ...
        self.HelpCommand = f'1help{CMD_INDEX}'
        ...
        self.LeechSetCommand = f'1leechset{CMD_INDEX}'
        self.SetThumbCommand = f'1setthumb{CMD_INDEX}'
